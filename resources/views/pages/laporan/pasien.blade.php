    ...
    <div class="bg-white rounded-2xl shadow-lg p-6">
        <div class="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
            ...
            <div class="w-full md:w-auto flex flex-col sm:flex-row items-center gap-4">
                <div class="relative w-full">
                    <input type="search" placeholder="Search .." class="w-full sm:w-80 h-12 pl-5 pr-10 rounded-xl border border-black focus:outline-none focus:ring-2 focus:ring-[#85a947] text-lg">
